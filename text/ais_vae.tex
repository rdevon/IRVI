...
\begin{minipage}{\textwidth}
    \begin{minipage}[l]{0.5\textwidth}
        \begin{tabular}{ | m{8em} | m{1.4cm} | m{1.4cm} | } 
            ...
            \hline
        \end{tabular}
    \captionof{table}{Lower bounds and NLL for various continuous latent variable models and training algorithms. \textasteriskcentered{Approximate value from \cite{kingma2013auto}.} \textdagger{Using the Larochelle dataset and validation dataset during training}. \textdaggerdbl{Sampling from continuous MNIST.}}
...
n & 1 & 5 & 10 & 20 & 50 \\
\hline
$\ge$ -log(x) & 95.15 & 92.74 & 92.33 & 90.75 & 91.31\\
\hline
$\approx$ -log(x) & 94.34 & 90.74 & 89.98 & 88.65 & 88.71 \\
\hline
\end{tabular}
\caption{Results for models trained with GDIR with number of steps, $n$, during training on the validation. Each model above was evaluated using $100$ steps and $300$ samples during inference.}
