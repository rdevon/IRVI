...
Normalizing flows for VAE \citep{rezende2015variational} make use of auxiliary networks to improve the approximate posterior. In doing so, they are able to escape the factorial condition that GDIR and AIR have. However, they require additional parameters to improve the posterior as well as a complex learning algorithm.
